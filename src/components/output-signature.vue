      ...
      <section>
        ...
        <tr>
            <td valign="top" style="padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 7px; border-top: 0; border-bottom: 0: border-left: 0;">
              <a href="https://www.guttershutterli.com/" target="_blank">
                <img v-show="mobilePhoneSwitch" width="220" height="139" style="width: 220px; max-width: 220px !important; height: 139px; max-height: 139px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/3449/gs-li-sign.png" name="preview-image-url" />
        
                <img v-show="!mobilePhoneSwitch" width="190" height="121" style="width: 190px; max-width: 190px !important; height: 121px; max-height: 121px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/3449/gs-li-sign.png" name="preview-image-url" />
              </a>
            </td>
            ...
            "background: none; border-width: 0px; border: 0px; margin: 0; padding: 0;">
              <tr>
                  <td colspan="2" style=
                  "padding-bottom: 5px; color: #0095da; font-size: 18px; font-family: Arial, Helvetica, sans-serif;">
                  {{fullName}}
                  </td>
                </tr>
                <tr>
              ...
              <div v-show="!mobilePhoneSwitch">
                ...
                <tr>
                  ...
                  "vertical-align: top; width: 20px; color: #0095da; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">
                  Direct:
                  </td>
                  <td valign="top" style=
                ...
                <tr>
                  ...
                  <td valign="top" style=
                  "vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">
                  <a href="https://www.guttershutterli.com/" target="_blank" style=
                  "color: #333333; text-decoration: none; font-weight: normal; font-size: 14px;">
                    guttershutterli.com</a>
                    &nbsp;&nbsp;
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2" style="padding-top: 5px;">
                    <a href="https://www.facebook.com/GuttershutterLI" target="_blank" style=
        ...
        <p><a href="https://www.guttershutterli.com/about-us/refer-give-to-get.html" style="font-weight:bold; color:#000;">We <i>LOVE Referrals</i><img width="20" height="20" style="border: none; width: 20px; max-width: 20px !important; height: 20px; max-height: 20px !important;" src="https://cdn.treehouseinternetgroup.com/cms_images/48/cursor-click.png" /></a></p>
         <p style="font-size: 14px"><b>HELPING THOSE IN NEED: 1 Google Review = $1 donated to Long Island Cares</b> <a href="https://www.google.com/maps/place/Gutter+Shutter+of+Long+Island/@40.8448826,-72.9913171,17z/data=!3m1!4b1!4m5!3m4!1s0x89e845fdbd70ec1b:0xc1e06106e68714c8!8m2!3d40.8448826!4d-72.9913171" style="font-weight:bold; color:#000;"> <br>(Click here to leave us a review)
         </a></p>
