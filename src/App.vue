      ...
      <div class="hero-body">
        <div class="container">
          <div class="th-logo has-text-centered">
            <img src="https://cdn.treehouseinternetgroup.com/cms_images/3449/gs-li-logo.png" alt="" style="width:250px">
          </div>
 ...
 <!----------------- Modal ---------------->    
        ...
        <modal name="output" :height="500">
          ...
          <div class="gif-box level-item has-text-centered">
            <ul>
              <li>1. Place cursor at the top-left corner of Gutter Shutter of Long Island logo and click & drag to bottom-right corner of the disclaimer</li>
    ...
    <footer class="" id="footer">
        <div class="container">
            <div class="content has-text-centered">
                <p>
                    &copy;2022 Gutter Shutter of Long Island
                </p>
            </div>
        </div>
    </footer>
